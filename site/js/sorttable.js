/*
  ...
  Modifications en français par Kévin Bélellou
*/
      ...
      if (!headrow[i].className.match(/\bsorttable_nosort\b/)) { // skip this col
        ...
        if (mtch) { override = mtch[1]; }
	      ...
	      headrow[i].sorttable_tbody = table.tBodies[0];
              ...
              // ------------------------------
              // Ajout de symboles à toutes les colonnes que l'on veut pouvoir trier
              fleche_haut = document.createElement('span');
              fleche_bas = document.createElement('span');
              fleche_haut.className = "fleche_haut";
              fleche_bas.className = "fleche_bas";
              fleche_haut.innerHTML = '&nbsp;&#x25B3';
          ...
          // ------------------------------
          // RAZ de l'ancienne colonne
          ancien = document.querySelector(".sorttable_sorted");
          if (ancien) {
